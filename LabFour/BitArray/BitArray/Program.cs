...
var m1 = new BitMatrixEx(2, 3, 1, 0, 1, 1, 1, 0);
var m2 = new BitMatrixEx(2, 3, 1, 1, 0, 1, 1, 0);
//czy & jest symetryczny
if( (m1 & m2).Equals(m2 & m1) )
    Console.WriteLine("Correct data, symmetry: Pass");

//czy wykonany poprawnie &
var expected = new BitMatrixEx(2, 3, 1, 0, 0, 1, 1, 0);
var m3 = m1 & m2;
...
// argument `null & null`
try {
    var m = (BitMatrixEx)null & (BitMatrixEx)null;
    Console.WriteLine(m);
...
// right argument `null`
try {
    var m = (BitMatrixEx)null & new BitMatrixEx(2,2);
    Console.WriteLine(m);
...
// left argument `null`
try {
    var m = new BitMatrixEx(2,2) & (BitMatrixEx)null;
    Console.WriteLine(m);
...
try {
    var m = new BitMatrixEx(2,3) & new BitMatrixEx(2, 2);
    Console.WriteLine(m);
